...
> [!WARNING]
> Luma 0.3 is a developer preview. Keep a remote backup and begin with non-critical repositories.
...
```sh
cosign verify-blob --bundle Luma-0.3.0.AppImage.sigstore.json \
...
**Settings** — editor, Git behavior, themes, interface sounds and the anonymous update check. This install runs 0.3.0.
